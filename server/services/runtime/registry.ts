...
const has = (obj: object, key?: string): boolean => !!key && Object.prototype.hasOwnProperty.call(obj, key);

export const getRuntimeImage = (runtime?: string, version?: string): { name: string; tag: string } => {
...
export const getDefaultPort = (runtime?: string): number =>
